...
export default function Achievements(){
  ...
  <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-7 sm:grid-cols-1 md:w-11/12 w-10/12 m-auto lg:py-8 py-4">
    <div className="h-80 border-2 border-white rounded-3xl w-11/12 px-3 hover:border-purple-500 hover:-translate-y-4"> <img src="/leetcode.png" className="w-10/12 m-auto h-32 mt-5 rounded-3xl cover mb-7"></img>
    ...
    <div className="h-80 border-2 border-white rounded-3xl w-11/12 px-3 hover:border-purple-500 hover:-translate-y-4"> <img src="/hacker.png" className="w-10/12 m-auto h-32 mt-5 rounded-3xl cover mb-7"></img>
    ...
    <div className="h-80 border-2 border-white rounded-3xl w-11/12 px-3 hover:border-purple-500 hover:-translate-y-4"> <img src="/codeforce.png" className="w-10/12 m-auto h-32 mt-5 rounded-3xl cover mb-7"></img>
    ...
    <div className="h-80 border-2 border-white rounded-3xl w-11/12 px-3 hover:border-purple-500 hover:-translate-y-4"> <img src="/codechef.png" className="w-10/12 m-auto h-32 mt-5 rounded-3xl cover mb-7"></img>
    <a href="https://www.codechef.com/users/anjali_shady" target="_blank" className="font-medium text-2xl text-left p-3 text-white hover:underline">Codechef Profiel</a>
